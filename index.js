...
if(localStorage.getItem('numNota')==null||localStorage.getItem('numNota')=="NaN"){
  console.log(config.numNota)
  localStorage.setItem('numNota', parseInt(config.numNota))
}
if(localStorage.getItem('timeINV')==null){
  localStorage.setItem('timeINV', 0)
}
